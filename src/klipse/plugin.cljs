...
(defn klipsify-with-opts [element {:keys [eval_idle_msec minimalistic_ui] :or {eval_idle_msec 20 minimalistic_ui false}} {:keys [editor-in-mode editor-out-mode eval-fn comment-str]}]
  (go
    (when element
